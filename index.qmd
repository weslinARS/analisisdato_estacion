...
data_ofena <- read.csv("/home/wars/Documents/proyectos/ulsa/analisisdato_estacion/ultimosdatos/data_ofena.csv")
wema_temp <- read.csv("/home/wars/Documents/proyectos/ulsa/analisisdato_estacion/ultimosdatos/MedicionesTemperatura.csv")
wema_humedad <- read.csv("/home/wars/Documents/proyectos/ulsa/analisisdato_estacion/ultimosdatos/MedicionesHumedad.csv")
wema_dirviento <- read.csv("/home/wars/Documents/proyectos/ulsa/analisisdato_estacion/ultimosdatos/MedicionesDirviento.csv")
wema_presion <- read.csv("/home/wars/Documents/proyectos/ulsa/analisisdato_estacion/ultimosdatos/MedicionesPresion.csv")
wema_velviento <- read.csv("/home/wars/Documents/proyectos/ulsa/analisisdato_estacion/ultimosdatos/MedicionVelViento.csv")
wema_luzvisible <- read.csv("/home/wars/Documents/proyectos/ulsa/analisisdato_estacion/ultimosdatos/mediciones_luz_visible.csv")
wema_luzuv <- read.csv("/home/wars/Documents/proyectos/ulsa/analisisdato_estacion/ultimosdatos/mediciones_uv.csv")
...
#-------luz visible
wema_luzvisible <- wema_luzvisible %>% select(Hora, Fecha, medicion)
cant_original_luzvisible_wema <- nrow(wema_luzvisible)
cant_na_luzvisible_wema <- sum(is.na(wema_luzvisible$medicion))
wema_luzvisible <- na.omit(wema_luzvisible)
wema_luzvisible_def <- wema_luzvisible

#-------luz uv
wema_luzuv <- wema_luzuv %>% select(Hora, Fecha, medicion)
cant_original_luzuv_wema <- nrow(wema_luzuv)
cant_na_luzuv_wema <- sum(is.na(wema_luzuv$medicion))
wema_luzuv <- na.omit(wema_luzuv)
wema_luzuv_def <- wema_luzuv
...
extraer_series_wema <- function(dataserieOfena, datasetWema, datasetOfena, colMedicionOfena) {
  ...
  for (i in 1:nrow(dataserieOfena)) {
    ...
    dataserieOfena$'dif C.V' <- abs(dataserieOfena$CoefVariacionOFENA - dataserieOfena$CoefVariacionWEMA)
...
### Resumen Series de Mediciones Temperatura

```{r, echo=FALSE}
library(knitr)
maxmin <- prom_err_series_velviento %>% summarise('Max. Prom E. Abs.' = max(PromEAbs), 'Min. Prom E. Abs.' = min(PromEAbs), 'Max. Prom E. Rel.' = min(PromERel), 'Min. Prom E. Rel'= min(PromERel))
kable(maxmin)

promedios <- prom_err_series_velviento %>% summarise('Prom. General E. Abs.'=mean(PromEAbs), 'Prom. General E. Rel.' = mean(PromERel),'Mediciones Totales' = sum(prom_err_series_velviento$cantMediciones))
...
prom_err_series_temperatura$indice <- seq_along(prom_err_series_temperatura$PromEAbs)

ggplot(prom_err_series_temperatura, aes(x = factor(indice), y = PromEAbs)) +
  geom_bar(stat = 'identity', fill = "green3") +
  geom_label(aes(label = round(PromEAbs, 3)), fill = "white", color = "blue3", size = 3, label.size = 0.5, vjust = -0.5, angle = 45) +
  labs(title = 'Gráfico de barras para los promedios de error absoluto', x = 'Índice', y = 'Prom. Errores Absolutos') +
  theme_minimal() 


ggplot(prom_err_series_temperatura, aes(x = factor(indice), y = PromEPorc)) +
  geom_bar(stat = 'identity', fill = "blue3") +
  geom_label(aes(label = round(PromEPorc, 3)), fill = "white", color = "blue3", size = 3, label.size = 0.5, vjust = -0.5, angle = 45) +
  labs(title = 'Gráfico de barras para los promedios de error relativo', x = 'Índice', y = 'Prom. Errores Relativos (%)') +
  theme_minimal() 

```

### Comparación Coeficiente de Variacion Entre Temperatura Real y Mediciones de la Estación WEMA

```{r , echo=FALSE}
kable(res_wema_temp_s_cv, caption = "coeficiente de variacion, para las series de temperatura encontrada")

maxmin <- res_wema_temp_s_cv %>% summarise('Max. C.V WEMA' = max(CoefVariacionWEMA) , 'Min C.V WEMA' = min(CoefVariacionWEMA),'Max C.V OFENA' = max(CoefVariacionOFENA), 'Min C.V OFENA'= min(CoefVariacionOFENA))
kable(maxmin)
promedios <- res_wema_temp_s_cv %>% summarise('Promedio General C.V OFENA' = mean(CoefVariacionOFENA), 'Promedio General C.V WEMA' = mean(CoefVariacionWEMA),'Promedio General dif. C.V' = mean(`dif C.V`))
...
ggplot(res_wema_temp_s_cv, aes(x = NoSerie)) +
    ...
    geom_label(aes(y = CoefVariacionOFENA, label = round(CoefVariacionOFENA, 2)),
        fill = "white", color = "blue3", size = 3, label.size = 0.3, vjust = 0.5, hjust = 1
    ) +
    labs(
        title = "Comparación Coeficiente de variación de mediciones de temperatura para la estación OFENA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c("C.V OFENA" = "blue3"))
```
...
ggplot(res_wema_temp_s_cv, aes(x = NoSerie)) +
    ...
    geom_label(aes(y = CoefVariacionWEMA, label = round(CoefVariacionWEMA, 2)),
        fill = "white", color = "green3", size = 3, label.size = 0.3, vjust = -1
    ) +
    labs(
        title = "Comparación Coeficiente de variacion de mediciones de temperatura para la estación WEMA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c( "C.V WEMA" = "green3"))
```
...
ggplot(res_wema_temp_s_cv, aes(x = NoSerie)) +
    ...
    geom_line(aes(y = CoefVariacionWEMA, group = 1, color = "C.V WEMA"))+
    labs(
        title = "Comparación Coeficiente de variacion entre  temperatura real y medición para las estaciones WEMA Y OFENA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c("C.V OFENA" = "blue3", "C.V WEMA" = "green3"))
...
mtbf_temperatura <- mtbf_calc(h_total_planificado, summ_disponibilidad_temperatura$cantHorasInterrupcion, summ_disponibilidad_temperatura$cantParadas)
...
# mostrar resultados
kable(data.frame(MTBF = mtbf_temperatura, MTTR = mttr_temperatura, 'Horas Planificadas'= h_total_planificado), caption = "Resultados de disponibilidad para la medición de temperatura")
```

## Resultados de la Variable Presión

### Limpieza de Datos OFENA

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad datos OFENA original | `r cant_original_presion_ofena` |
| Cantidad de datos Nulos OFENA | `r cant_na_presion_ofena` |
| Cantidad de datos limpios en intervalos de 5 minutos | `r nrow(data_presion_ofena)` |

: Resumen de limpieza de datos, para la variable de presión datos OFENA

### Limpieza de Datos WEMA

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad datos WEMA original | `r cant_original_presion_wema` |
| Cantidad de datos Nulos WEMA | `r cant_na_presion_wema` |
| Cantidad de datos limpios en intervalos de 5 minutos | `r nrow(wema_presion)` |

: Resumen limpieza de datos, para la variable de presión

### Series de Datos Analizados

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad de series a analizar | `r  nrow(res_wema_presion_s_cv)` series |
| Cantidad de series descartadas | `r nrow(res_wema_presion$series_descartadas)` series |
| Cantidad de series encontradas | `r nrow(data_serie_presion)` series |

: Resumen de las series de datos para la variable de presión

### Resumen de Series de Mediciones Presión

```{r, echo=FALSE}
library(knitr)
maxmin <- prom_err_series_presion %>% summarise('Max. Prom E. Abs.' = max(PromEAbs), 'Min. Prom E. Abs.' = min(PromEAbs), 'Max. Prom E. Rel.' = min(PromERel), 'Min. Prom E. Rel'= min(PromERel))
kable(maxmin)

promedios <- prom_err_series_presion %>% summarise('Prom. General E. Abs.'=mean(PromEAbs), 'Prom. General E. Rel.' = mean(PromERel),'Mediciones Totales' = sum(prom_err_series_velviento$cantMediciones))
...
### Comparación de Errores para las Series de Presión

```{r, echo=FALSE}
#--------------PRESION
kable(prom_err_series_presion, caption = "Promedio de Errores para las series de presión")
```
...
prom_err_series_presion$indice <- seq_along(prom_err_series_presion$PromEAbs)

ggplot(prom_err_series_presion, aes(x = factor(indice), y = PromEAbs)) +
  geom_bar(stat = 'identity', fill = "green3") +
  geom_label(aes(label = round(PromEAbs, 3)), fill = "white", color = "blue3", size = 3, label.size = 0.5, vjust = -0.5, angle = 45) +
  labs(title = 'Gráfico de barras para los promedios de error absoluto', x = 'Índice', y = 'Prom. Errores Absolutos') +
  theme_minimal() 

ggplot(prom_err_series_presion, aes(x = factor(indice), y = PromEPorc)) +
  geom_bar(stat = 'identity', fill = "blue3") +
  geom_label(aes(label = round(PromEPorc, 3)), fill = "white", color = "blue3", size = 3, label.size = 0.5, vjust = -0.5, angle = 45) +
  labs(title = 'Gráfico de barras para los promedios de error relativo', x = 'Índice', y = 'Prom. Errores Relativos (%)') +
  theme_minimal() 
...
### Comparación Coeficiente de Variacion Entre Presión Real y Mediciones de la Estación WEMA

```{r , echo=FALSE}
kable(res_wema_presion_s_cv, caption = "coeficiente de variacion, para las series de presión encontrada")

maxmin <- res_wema_presion_s_cv %>% summarise('Max. C.V WEMA' = max(CoefVariacionWEMA) , 'Min C.V WEMA' = min(CoefVariacionWEMA),'Max C.V OFENA' = max(CoefVariacionOFENA), 'Min C.V OFENA'= min(CoefVariacionOFENA))
kable(maxmin)
promedios <- res_wema_presion_s_cv %>% summarise('Promedio General C.V OFENA' = mean(CoefVariacionOFENA), 'Promedio General C.V WEMA' = mean(CoefVariacionWEMA),'Promedio General dif. C.V' = mean(`dif C.V`))
...
#| fig-width: 12
#| fig-height: 8
ggplot(res_wema_presion_s_cv, aes(x = NoSerie)) +
    geom_point(aes(y = CoefVariacionOFENA, color = "C.V OFENA"), size = 3) +
    geom_line(aes(y = CoefVariacionOFENA, group = 1, color = "C.V OFENA")) +
    geom_label(aes(y = CoefVariacionOFENA, label = round(CoefVariacionOFENA, 5)),
        fill = "white", color = "blue3", size = 3, label.size = 0.3, vjust = -1
    ) +
    labs(
        title = "Comparación Coeficiente de variación de las mediciones de presión para la estación OFENA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c( "C.V OFENA" = "blue3"))
...
ggplot(res_wema_presion_s_cv, aes(x = NoSerie)) +
    geom_point(aes(y = CoefVariacionWEMA, color = "C.V WEMA"), size = 3) +
    geom_line(aes(y = CoefVariacionWEMA, group = 1, color = "C.V WEMA")) +
    geom_label(aes(y = CoefVariacionWEMA, label = round(CoefVariacionWEMA, 5)),
        fill = "white", color = "green3", size = 3, label.size = 0.3, vjust = -1
    ) +
    labs(
        title = "Comparación Coeficiente de variacion de las mediciones de presión para la estación WEMA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c( "C.V WEMA" = "green3"))
...
print(ggplot(res_wema_presion_s_cv, aes(x = NoSerie)) +
    ...
    geom_line(aes(y = CoefVariacionWEMA, group = 1, color = "C.V WEMA")) +
    labs(
        title = "Comparación Coeficiente de variacion entre  presion real y medición para la variable de presión",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c("C.V OFENA" = "blue3", "C.V WEMA" = "green3")))
...
kable(dta_presion_frec_interrupciones, caption = "Frecuencia de interrupciones en la medición de presión")
...
fecha_fin <- as.POSIXct("2025-02-02 00:00:00", format = "%Y-%m-%d %H:%M:%S")
h_total_planificado <- as.numeric(difftime(fecha_fin, fecha_inicio, units = "hours"))
mtbf_presion <- mtbf_calc(h_total_planificado, summ_disponibilidad_presion$cantHorasInterrupcion, summ_disponibilidad_presion$cantParadas)
...
# mostrar resultados
kable(data.frame(MTBF = mtbf_presion, MTTR = mttr_presion, 'Horas Planificadas'=h_total_planificado), caption = "Resultados de disponibilidad para la medición de presion")

```

## Resultados de la Variable Humedad

### Limpieza de Datos OFENA

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad datos OFENA original | `r cant_original_humedad_ofena` |
| Cantidad de datos Nulos OFENA | `r cant_na_humedad_ofena` |
| Cantidad de datos limpios en intervalos de 5 minutos | `r nrow(data_humedad_ofena)` |

: Resumen de limpieza de datos, para la variable de humedad datos OFENA

### Limpieza de Datos WEMA

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad datos WEMA original | `r cant_original_humeda_wema` |
| Cantidad de datos Nulos WEMA | `r cant_na_humedad_wema` |
| Cantidad de datos limpios en intervalos de 5 minutos | `r nrow(wema_humedad)` |

: Resumen limpieza de datos, para la variable de humedad

### Series de Datos Analizados

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad de series a analizar | `r  nrow(res_wema_humedad_s_cv)` series |
| Cantidad de series descartadas | `r nrow(res_wema_humedad$series_descartadas)` series |
| Cantidad de series encontradas | `r nrow(data_serie_humedad)` series |
...
```{r,echo=FALSE}
maxmin <- prom_err_series_humedad %>% summarise('Max. Prom E. Abs.' = max(PromEAbs), 'Min. Prom E. Abs.' = min(PromEAbs), 'Max. Prom E. Rel.' = min(PromERel), 'Min. Prom E. Rel'= min(PromERel))
kable(maxmin)

promedios <- prom_err_series_humedad %>% summarise('Prom. General E. Abs.'=mean(PromEAbs), 'Prom. General E. Rel.' = mean(PromERel),'Mediciones Totales' = sum(prom_err_series_velviento$cantMediciones))

kable(promedios)

```

### Comparación de Errores para las Series de Humedad
...
prom_err_series_humedad$indice <- seq_along(prom_err_series_humedad$PromEAbs)

ggplot(prom_err_series_humedad, aes(x = factor(indice), y = PromEAbs)) +
  geom_bar(stat = 'identity', fill = "green3") +
  geom_label(aes(label = round(PromEAbs, 3)), fill = "white", color = "blue3", size = 3, label.size = 0.5, vjust = -0.5, angle = 45) +
  labs(title = 'Gráfico de barras para los promedios de error absoluto', x = 'Índice', y = 'Prom. Errores Absolutos') +
  theme_minimal() 

ggplot(prom_err_series_humedad, aes(x = factor(indice), y = PromEPorc)) +
  geom_bar(stat = 'identity', fill = "blue3") +
  geom_label(aes(label = round(PromEPorc, 3)), fill = "white", color = "blue3", size = 3, label.size = 0.5, vjust = -0.5, angle = 45) +
  labs(title = 'Gráfico de barras para los promedios de error relativo', x = 'Índice', y = 'Prom. Errores Relativos (%)') +
  theme_minimal() 
...
### Comparación Coeficiente de Variacion Entre Humedad Real y Mediciones de la Estación WEMA
...
maxmin <- res_wema_humedad_s_cv %>% summarise('Max. C.V WEMA' = max(CoefVariacionWEMA) , 'Min C.V WEMA' = min(CoefVariacionWEMA),'Max C.V OFENA' = max(CoefVariacionOFENA), 'Min C.V OFENA'= min(CoefVariacionOFENA))
kable(maxmin)
promedios <- res_wema_humedad_s_cv %>% summarise('Promedio General C.V OFENA' = mean(CoefVariacionOFENA), 'Promedio General C.V WEMA' = mean(CoefVariacionWEMA),'Promedio General dif. C.V' = mean(`dif C.V`))
...
#| fig-width: 12
#| fig-height: 8
ggplot(res_wema_humedad_s_cv, aes(x = NoSerie)) +
    geom_point(aes(y = CoefVariacionOFENA, color = "C.V OFENA"), size = 3) +
    geom_line(aes(y = CoefVariacionOFENA, group = 1, color = "C.V OFENA")) +
    geom_label(aes(y = CoefVariacionOFENA, label = round(CoefVariacionOFENA, 5)),
        fill = "white", color = "blue3", size = 3, label.size = 0.3, vjust = -1
    ...
    labs(
        title = "Comparación Coeficiente de variación de las mediciones de humedad para la estación OFENA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c( "C.V OFENA" = "blue3"))
...
ggplot(res_wema_humedad_s_cv, aes(x = NoSerie)) +
    ...
    labs(
        title = "Comparación Coeficiente de variación de las mediciones de humedad para la estación WEMA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c( "C.V WEMA" = "green3"))
...
fecha_fin <- as.POSIXct("2025-02-02 00:00:00", format = "%Y-%m-%d %H:%M:%S")
h_total_planificado <- as.numeric(difftime(fecha_fin, fecha_inicio, units = "hours"))
mtbf_humedad <- mtbf_calc(h_total_planificado, summ_disponibilidad_humedad$cantHorasInterrupcion, summ_disponibilidad_humedad$cantParadas)
...
# mostrar resultados
kable(data.frame(MTBF = mtbf_humedad, MTTR = mttr_humedad, 'Horas Planificadas'=h_total_planificado), caption = "Resultados de disponibilidad para la medición de humedad")
```

## Resultados de la Variable Direccion del Viento

### Limpieza de Datos OFENA

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad datos OFENA original | `r cant_original_dirviento_ofena` |
| Cantidad de datos Nulos OFENA | `r cant_na_dirviento_ofena` |
| Cantidad de datos limpios en intervalos de 5 minutos | `r nrow(data_dirviento_ofena)` |

: Resumen de limpieza de datos, para la variable de dirección del viento datos OFENA

### Limpieza de Datos WEMA

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad datos WEMA original | `r cant_original_dirviento_wema` |
| Cantidad de datos Nulos WEMA | `r cant_na_dirviento_wema` |
| Cantidad de datos limpios en intervalos de 5 minutos | `r nrow(wema_dirviento)` |

: Resumen limpieza de datos, para la variable de dirección del viento

### Series de Datos Analizados

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad de series a analizar | `r  nrow(res_wema_dirviento_s_cv)` series |
| Cantidad de series descartadas | `r nrow(res_wema_dirviento$series_descartadas)` series |
| Cantidad de series encontradas | `r nrow(data_serie_dirviento)` series |

: Resumen de las series de datos para la variable de dirección del viento

### Resumen Series de Mediciones Direccion del Viento

```{r,echo=FALSE}
if (nrow(data_serie_dirviento) < 1) {
...
kable(resumen_serie_dirviento, caption = "Resumen para las series de mediciones de direccion del viento")
  ...
  print("No se encontraron series para analizar.")
}

```

### Comparación Coeficiente de Variacion Entre Direccion del Viento Real y Mediciones de la Estación WEMA
...
fecha_fin <- as.POSIXct("2025-02-02 00:00:00", format = "%Y-%m-%d %H:%M:%S")
h_total_planificado <- as.numeric(difftime(fecha_fin, fecha_inicio, units = "hours"))
mtbf_dirviento <- mtbf_calc(h_total_planificado , summ_disponibilidad_dirviento$cantHorasInterrupcion, summ_disponibilidad_dirviento$cantParadas)
# disponibilidad
...
# mostrar resultados
kable(data.frame(MTBF = mtbf_dirviento, MTTR = mttr_dirviento, 'Horas Planificadas'= h_total_planificado), caption = "Resultados de disponibilidad para la medición de direccion del viento")

```

## Resultados de la Variable Velocidad del Viento

### Limpieza de Datos OFENA

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad datos OFENA original | `r cant_original_velviento_ofena` |
| Cantidad de datos Nulos OFENA | `r cant_na_velviento_ofena` |
| Cantidad de datos limpios en intervalos de 5 minutos | `r nrow(data_velviento_ofena)` |

: Resumen de limpieza de datos, para la variable de velocidad del viento OFENA

### Limpieza de Datos WEMA

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad datos WEMA original | `r cant_original_velviento_wema` |
| Cantidad de datos Nulos WEMA | `r cant_na_velviento_wema` |
| Cantidad de datos limpios en intervalos de 5 minutos | `r nrow(wema_velviento)` |

: Resumen limpieza de datos, para la variable de velocidad del viento

### Series de Datos Analizados

|   | Resultado |
|------------------------------------|------------------------------------|
| Cantidad de series a analizar | `r  nrow(res_wema_velviento_s_cv)` series |
| Cantidad de series descartadas | `r nrow(res_wema_velviento$series_descartadas)` series |
| Cantidad de series encontradas | `r nrow(data_serie_velviento)` series |

: Resumen de las series de datos para la variable de velocidad del viento
...
prom_err_series_velviento$indice <- seq_along(prom_err_series_velviento$PromEAbs)

ggplot(prom_err_series_velviento, aes(x = factor(indice), y = PromEAbs)) +
  geom_bar(stat = 'identity', fill = "green3") +
  geom_label(aes(label = round(PromEAbs, 3)), fill = "white", color = "blue3", size = 3, label.size = 0.5, vjust = -0.5, angle = 45) +
  labs(title = 'Gráfico de barras para los promedios de error absoluto', x = 'Índice', y = 'Prom. Errores Absolutos') +
  theme_minimal() 

ggplot(prom_err_series_velviento, aes(x = factor(indice), y = PromEPorc)) +
  geom_bar(stat = 'identity', fill = "blue3") +
  geom_label(aes(label = round(PromEPorc, 3)), fill = "white", color = "blue3", size = 3, label.size = 0.5, vjust = -0.5, angle = 45) +
  labs(title = 'Gráfico de barras para los promedios de error relativo', x = 'Índice', y = 'Prom. Errores Relativos (%)') +
  theme_minimal() 
...
### Comparación Coeficiente de Variacion Entre Velocidad del Viento Real y Mediciones de la Estación WEMA

```{r, echo=FALSE}

kable(res_wema_velviento_s_cv, caption = "coeficiente de variacion, para las series de velocidad del viento encontrada")

maxmin <- res_wema_velviento_s_cv %>% summarise('Max. C.V WEMA' = max(CoefVariacionWEMA) , 'Min C.V WEMA' = min(CoefVariacionWEMA),'Max C.V OFENA' = max(CoefVariacionOFENA), 'Min C.V OFENA'= min(CoefVariacionOFENA))
kable(maxmin)
promedios <- res_wema_velviento_s_cv %>% summarise('Promedio General C.V OFENA' = mean(CoefVariacionOFENA), 'Promedio General C.V WEMA' = mean(CoefVariacionWEMA),'Promedio General dif. C.V' = mean(`dif C.V`))
...
#| fig-width: 12
#| fig-height: 8
ggplot(res_wema_velviento_s_cv, aes(x = NoSerie)) +
    geom_point(aes(y = CoefVariacionOFENA, color = "C.V OFENA"), size = 3) +
    geom_line(aes(y = CoefVariacionOFENA, group = 1, color = "C.V OFENA")) +
    geom_label(aes(y = CoefVariacionOFENA, label = round(CoefVariacionOFENA, 5)),
        fill = "white", color = "blue3", size = 3, label.size = 0.3, vjust = -1
    ...
    labs(
        title = "Comparación Coeficiente de variacion de mediciones de dirección del viento para la la estación OFENA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c( "C.V OFENA" = "blue3"))
...
ggplot(res_wema_velviento_s_cv, aes(x = NoSerie)) +
    ...
    labs(
        title = "Comparación Coeficiente de variacion para las mediciones de velocidad del viento para la estación WEMA",
        y = "C.V", x = "No. serie"
    ) +
    theme_minimal() +
    scale_color_manual(values = c( "C.V WEMA" = "green3"))
...
fecha_fin <- as.POSIXct("2025-02-02 00:00:00", format = "%Y-%m-%d %H:%M:%S")
h_total_planificado <- as.numeric(difftime(fecha_fin, fecha_inicio, units = "hours"))
mtbf_velviento <- mtbf_calc(h_total_planificado , summ_disponibilidad_velviento$cantHorasInterrupcion, summ_disponibilidad_velviento$cantParadas)
...
# mostrar resultados
kable(data.frame(MTBF = mtbf_velviento, MTTR = mttr_velviento, 'Horas Planificadas'=h_total_planificado), caption = "Resultados de disponibilidad para la medición de velocidad del viento")
```
